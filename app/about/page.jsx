  ...
  return (
    <>
      ...
      <div className='w-full h-[100vh] flex items-center justify-center relative'>
        <img src="images/about/bg.png" className='w-full h-full absolute top-0 left-0' alt="" />
        <div className='w-full h-full bg-black/20 z-1 flex items-center justify-start text-start px-10'>
          <div className='w-full max-w-[800px] me-auto text-white z-10 p-4 ps-30 mb-auto mt-40'>
            ...
            <span>
              <p className=' font-extralight mt-4 w-[38vw] tracking-wide'>
      ...
      {/* section 2 */}
      <div className='w-full min-h-[100vh] flex items-center bg-gradient-to-b from-[#060406] to-[#D44E51] justify-center z-1'>
        <div className='w-full max-w-[50vw] text-white text-center z-10 p-4 ps-30 mb-auto me-auto ms-20 mt-40'>
          <h1 className='text-5xl font-extrabold mb-4 text-red-500'> Our Vision</h1>
          <p className='font-extralight mt-14 w-[38vw] text-start tracking-widest'>
          ...
          <p className='font-extralight mt-8 w-[38vw] text-start tracking-widest'>
          ...
          <ul className='font-extralight mt-8 ms-4 text-start tracking-widest list-disc list-inside mb-10'>
        ...
        <img src="images/about/char.png" className='absolute right-0' alt="" />
      </div>

      {/* section 3 */}
      <div className='w-full min-h-[110vh] flex items-center bg-gradient-to-b from-[#D44E51] to-[#0A0507] justify-center z-1 '>
        <div className='w-full max-w-[50vw] text-white text-center z-10 p-4 ps-30 mb-auto ms-auto me-20 mt-40'>
          <h1 className='text-5xl font-extrabold mb-4 text-red-500'> Our Mission</h1>
          <p className='font-extralight mt-14 w-[38vw] text-start tracking-widest'>
        ...
        <img src="images/about/target.png" className='absolute left-0 mt-60' alt="" />
      </div>
