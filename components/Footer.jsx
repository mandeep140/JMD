    ...
    return (
        <footer>
            <div className='w-full min-h-[60vh] bg-red-500 overflow-hidden relative'>
                ...
                <div className='flex flex-col lg:flex-row items-center justify-evenly min-h-full z-1 gap-10 lg:gap-0 px-4 py-8'>
                    <div className='h-auto w-full max-w-xs mt-8 z-1 flex items-center justify-center flex-col'>
                        ...
                        <p className='mt-4 text-sm font-extralight text-white/70 text-center lg:text-left'>Jai Mata Di Advertising, based in Harhargutu, Jamshedpur, is a decade strong and the fastest growing advertising agency in East India, committed to delivering effective, result-driven campaigns. With a deep understanding of client needs,
                            we focus on crafting impactful outdoor advertising solutions marked by quality, consistency, and commitment.</p>
                        <span className='w-full flex items-center justify-center lg:justify-start mt-8 text-black/70 text-2xl gap-4'>
                    ...
                    <div className='h-auto w-full max-w-[180px] mt-8 z-1 flex items-center justify-center flex-col'>
                        <h1 className='mb-auto text-xl font-bold text-black/60 w-full flex justify-center lg:justify-start'>QUICK LINKS</h1>
                    ...
                    <div className='h-auto w-full max-w-[200px] mt-8 z-1 flex items-center justify-center flex-col'>
                        <h1 className='mb-auto text-lg font-bold text-black/60 w-full flex justify-center lg:justify-start'>EXPLORE SERVICES</h1>
                        <span className='w-full flex items-start justify-start flex-col gap-2 text-black/70 mb-auto'>
                    ...
                    <div className='min-h-[17rem] w-full max-w-[220px] mt-8 pt-9 z-1 flex items-center justify-center flex-col gap-4'>
                        <h1 className='mb-auto text-lg font-bold text-black/60 w-full flex justify-center lg:justify-start'>CONTACT INFO</h1>
                        <span className='w-full flex items-start justify-start flex-col gap-2 text-black/70 mb-auto'>
                            <span>
                ...
                <div className='w-[90%] flex flex-col md:flex-row text-center justify-between mx-auto items-center my-4 z-1 gap-2'>
                    ...
                    <p className='text-center text-white/70 text-sm z-1'>Created With Love By <a href="https://www.showa.online" target='_blank' rel="noopener noreferrer"><b className='hover:text-black/70 duration-150 cursor-pointer'>Showa.online</b></a></p>
                </div>
            </div>
        </footer>
    )
